...
const resources = {
  'zh-CN': {
    translation: {
      ...
      preview: {
        fontConsentTitle: '加载模板字体？',
        fontConsentDescription:
          '默认模板使用远程开源字体。仅在你确认后下载，只在当前页面的内存中使用，不会保存到 IndexedDB。',
        loadFont: '加载字体并预览',
        continueWithoutFont: '不加载并继续',
        compilationFailed: '预览编译失败',
        retry: '重试',
        loadTemplateFont: '加载模板字体',
        preparing: '正在准备预览',
        resourceWarnings: '{{count}} 个资源警告',
        phase: {
          'loading-template': '正在加载模板',
          'loading-font-resources': '正在加载字体资源',
          'initializing-typst-wasm': '正在初始化 Typst WASM',
  ...
  'en-US': {
    translation: {
      ...
      data: {
        ...
        downloadFormat: 'Choose data format',
      ...
      preview: {
        fontConsentTitle: 'Load the template font?',
        fontConsentDescription:
          'The default template uses a remote open-source font. It is downloaded only after your confirmation, kept in memory for this page, and never stored in IndexedDB.',
        loadFont: 'Load font and preview',
        continueWithoutFont: 'Continue without it',
        compilationFailed: 'Preview compilation failed',
        retry: 'Retry',
        loadTemplateFont: 'Load template font',
        preparing: 'Preparing preview',
        resourceWarnings: '{{count}} resource warning(s)',
        phase: {
          'loading-template': 'Loading template',
          'loading-font-resources': 'Loading font resources',
          'initializing-typst-wasm': 'Initializing Typst WASM',
